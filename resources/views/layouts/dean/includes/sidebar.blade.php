...
<li class="sidebar-item @if(isset($dashboard)){{ $dashboard }}@endif">
    <a href="{{ route('dean.dashboard') }}" class='sidebar-link'>
...
<li class="sidebar-item  has-sub">
    ...
    <ul class="submenu ">
        <li class="submenu-item @if(isset($loadsubject)){{ $loadsubject }}@endif">
            <a href="{{ route('dean.loadsubjects') }}">Load Subject</a>
        </li>
...
<li class="sidebar-item">
    <a href="{{ route('dean.logout') }}" class='sidebar-link'>
